...
const evenNumbers  = mixedNumbers.filter(el => !(el%2))
...
const totalPopulation = populations.reduce((total, el) => total+ el)
...
const bobsTotal = orders.reduce((total, purchase) => total + purchase["price"], 0)
